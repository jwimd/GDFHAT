...
parser.add_argument('--data_dir', type=str, default='../AID_SR_4x')
...
parser.add_argument('--save_folder', default='saved_models/gdfhat/', help='Location to save checkpoint models')
parser.add_argument('--log_folder', default='tb_logs/gdfhat/', help='Location to save checkpoint models')
