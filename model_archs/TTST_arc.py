...
class HAB(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv_block = TTSA(dim, num_heads, qkv_bias)  # replace CA with TTSA
...
class TTST(nn.Module):
    ...
    def __init__(self,
        ...
        print(f"img_size:{img_size}, patch_size:{patch_size}, in_chans:{in_chans}, embed_dim:{embed_dim}, depths:{depths}, num_heads:{num_heads}, window_size:{window_size}, compress_ratio:{compress_ratio}, squeeze_factor:{squeeze_factor}, conv_scale:{conv_scale}, overlap_ratio:{overlap_ratio}, mlp_ratio:{mlp_ratio}, qkv_bias:{qkv_bias}, qk_scale:{qk_scale}, drop_rate:{drop_rate}, attn_drop_rate:{attn_drop_rate}, drop_path_rate:{drop_path_rate}, norm_layer:{norm_layer}, ape:{ape}, patch_norm:{patch_norm}, use_checkpoint:{use_checkpoint}, upscale:{upscale}, img_range:{img_range}, upsampler:{upsampler}, resi_connection:{resi_connection}")
        self.window_size = window_size
