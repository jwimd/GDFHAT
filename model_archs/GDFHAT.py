...
class GDFOCAB(nn.Module):
    # gated-Dconv feed-forward overlapping cross-attention block
    ...
    def __init__(self, dim,
        ...
        #    img_size=img_size, patch_size=1, in_chans=dim, embed_dim=dim, norm_layer=None)
